...
if __name__ == "__main__":
    ...
    parser.add_argument("--iterations", dest="iterations", type=int, required=True, default=5)
    ...
    parser.add_argument("--output-singular-values", dest="output_singular_values", required=False, type=str)
    parser.add_argument("--output-components", dest="output_components", required=False, type=str)
